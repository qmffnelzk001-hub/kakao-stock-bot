...
app.post('/stock', async (req, res) => {
    try {
        ...
        const name = msg.replace('주식', '').replace(':', '').trim();
        ...
        res.json({ version: "2.0", template: { outputs: [{ simpleText: { text: "잠시 후 다시 시도해주세요." } }] } });
    }
});
